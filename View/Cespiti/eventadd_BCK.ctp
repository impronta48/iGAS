 ...
 */
    ...
    $this->Html->addCrumb('Event Add', ['controller' => 'cespiti', 'action' => 'eventadd']);
?>
<style>
...
<?php
	...
	echo $this->Form->input('Cespite.Nome', ['type'=>'text', 'label' => 'Cespite', 'class' => 'form-control required']);
	...
	*/
	echo $this->Form->input('event_type_id', ['empty' => 'Scegli il tipo di evento', 'options'=>$legenda_tipo_attivita_calendario, 'label'=>'Tipo Evento', 'class' => 'form-control']);
?>
<div class="form-group row">
<div class="col col-md-2 control-label"><strong>Evento Ripetuto</strong></div>
<div class="col col-md-10">
<?php	echo $this->Form->input('repeated', ['label' => ['class' => '', 'text'=>'SI'], 'class' => 'form-check-input', 'div' => false, 'wrapInput' => false]); ?>
</div>
</div>
<div class="form-group row" id="dateTimeNoRepeat">
<div class="col col-md-12">
<?php
	echo $this->Form->input('start', ['type'=>'text', 'label' => 'Data Inizio Evento', 'class' => 'form-control required', 'autocomplete' => 'off']);
...
<div class="col col-md-10">
	...
	<?php echo $this->Form->input('startTime', ['type'=>'text', 'label' => 'Ora inizio', 'class' => 'form-control required']); ?> 
	<?php echo $this->Form->input('endTime', ['type'=>'text', 'label' => 'Ora fine', 'class' => 'form-control required']); ?> 
	</div>
</div>
</div>
<?php
	echo $this->Form->input('prezzoAffitto', ['type'=>'text', 'label' => 'Prezzo Affitto Cespite Giornaliero']);
	echo $this->Form->input('prezzoAffittoTot', ['type'=>'text', 'label' => 'Prezzo Affitto Cespite Evento']);
