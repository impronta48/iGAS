    ...
    <div class="site-holder">
        ...
        <nav class="navbar " role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" title="iGas - Gestione Aziendale Semplice"
                    href="<?php echo $this->Html->url('/pages/home'); ?>">
                   ...
                   ?>
                    <li><a href="#" class="user dropdown-toggle" data-toggle="dropdown"><span
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a
                                    href="<?php echo $this->Html->url('/persone/edit/'. $this->Session->read('Auth.User.Persona.id')); ?>">
                                    Edita Profilo</a></li>
                            <?php } ?>
                            <li><a href="<?php echo $this->Html->url('/users/cambiapwd/'. $uid); ?>"> Cambia
                                    Password</a></li>
                            <li><a href="<?php echo $this->Html->url('/users/logout'); ?>" class="text-danger"><i
            ...
            <div class="left-sidebar">
                <div class="sidebar-holder">
                    <ul class="nav  nav-list">
                        ...
                        <li class="nav-toggle">
                            <button class="btn  btn-nav-toggle text-primary"><i
                                    class="fa fa-angle-double-left toggle-left"></i> </button>
                        </li>
