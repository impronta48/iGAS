...
<?php echo $this->Form->create('Ddt', array(
	...
	<?php
		...
		echo $this->Form->input('attivita_id', array('default'=>$a['Attivita']['id'], 'readonly'=>false));
    ...
    ?>
        <tr>            
            <td>
                <?php echo $this->Form->input("Rigaddt.$i.Descrizione", array('label'=>false, 'wrapInput'=>'col col-md-11', 'width'=>'80%')); ?>
            </td>
            <td>
                <?php echo $this->Form->input("Rigaddt.$i.um", array('label'=>false, 'wrapInput'=>'col col-md-11')); ?>
            </td>
            <td>
                <?php echo $this->Form->input("Rigaddt.$i.qta", array('label'=>false, 'wrapInput'=>'col col-md-11', 'class'=>'form-control add3')); ?>
            </td>
        </tr>
    <?php   
            $i++;
