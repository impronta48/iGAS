...
<?php echo $this->Form->create('Fatturaricevuta', [
	...
	<?php
		...
		echo $this->Form->input('dataFattura', ['type'=>'text', 'label' => 'Data Documento', 'dateFormat' => 'DMY', 'class'=> 'datepicker form-control',]);
		...
		echo $this->Form->input('scadPagamento', ['type'=>'text', 'label' => 'Data Documento', 'dateFormat' => 'DMY', 'class'=> 'datepicker form-control',]);
		echo $this->Form->input('ritenutaAcconto');		
		// echo $this->Form->input('scadenzaRitenutaAcconto', array('type' => 'date', 'dateFormat' => 'DMY', 'class'=>''));
		echo $this->Form->input('scadenzaRitenutaAcconto', ['type'=>'text', 'label' => 'Data Documento', 'dateFormat' => 'DMY', 'class'=> 'datepicker form-control',]);
		...
		echo $this->Form->input('pagato', ['class'=>false,'wrapInput' => 'col col-md-10 col-md-offset-2', 'type'=>'checkbox','enabled'=>'false']);
