...
<div class="fattureemesse view">   
    <div class="actions hidden-print">
        <a href="<?php echo $this->Html->url(['action'=>'view', $fatturaemessa['Fatturaemessa']['id'], 'ext' => 'pdf'])?>" class="btn btn-animate-demo btn-primary hidden-print"><i class="fa fa-file fa-2x"></i> Pdf</a>        
    </div>
