...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Delete'), ['action' => 'delete', $this->Form->value('Rigafattura.id')], null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('Rigafattura.id'))); ?></li>		
	</ul>
</div>