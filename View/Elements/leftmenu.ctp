...
<li>
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link("<i class='fa fa-user'></i><span class='hidden-minibar'> Utenti</span>", '/users', ['escape' => false, 'data-original-title' => 'Utenti']) ?></li>
    </ul>
</li>
...
<li>
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link("<i class='fa fa-briefcase'></i><span class='hidden-minibar'> Inserisci Nota Spese</span>", '/notaspese/scegli_persona', ['escape' => false, 'data-original-title' => 'Nota Spese']) ?></li>
...
<li>
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link('<i class="fa fa-calendar"></i> Statistiche Utilizzo Cespiti', '/cespiti/stats?from=' . date('Y-m-d', strtotime('first day of last month')), ['data-original-title' => 'Statistiche Utilizzo Cespiti', 'escape' => false]) ?></li>
