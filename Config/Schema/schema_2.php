...
class AppSchema extends CakeSchema {
	...
	public $attivita = array(
		...
		'indexes' => array(
			'PRIMARY' => array('column' => 'id', 'unique' => 1),
			'NomeAttività' => array('column' => 'name', 'unique' => 1),
			'AziendeAttività' => array('column' => 'azienda_id', 'unique' => 0),
			'NumOreConsuntivo' => array('column' => 'NumOreConsuntivo', 'unique' => 0),
			'ProgettoAttività' => array('column' => 'progetto_id', 'unique' => 0)
		),
		'tableParameters' => array('charset' => 'latin1', 'collate' => 'latin1_swedish_ci', 'engine' => 'MyISAM')
	);
	...
	public $faseattivita = array(
		'id' => array('type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary'),
		'attivita_id' => array('type' => 'integer', 'null' => true, 'default' => null),
		'Descrizione' => array('type' => 'string', 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'charset' => 'latin1'),
		'qta' => array('type' => 'float', 'null' => true, 'default' => null),
		'um' => array('type' => 'string', 'null' => true, 'default' => null, 'length' => 10, 'collate' => 'latin1_swedish_ci', 'charset' => 'latin1'),
		'costou' => array('type' => 'float', 'null' => true, 'default' => null),
		'legenda_stato_attivita_id' => array('type' => 'integer', 'null' => true, 'default' => null),
		'indexes' => array(
			'PRIMARY' => array('column' => 'id', 'unique' => 1)
		),
		'tableParameters' => array('charset' => 'latin1', 'collate' => 'latin1_swedish_ci', 'engine' => 'InnoDB')
	...
	public $fatturericevute = array(
		'id' => array('type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary'),
		'attivita_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'key' => 'index'),
		...
		'dataFattura' => array('type' => 'datetime', 'null' => true, 'default' => null),
		'fornitore_id' => array('type' => 'integer', 'null' => true, 'default' => null),
		...
		'ritenutaAcconto' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => '19,4'),
		'scadenzaRitenutaAcconto' => array('type' => 'date', 'null' => true, 'default' => null),
		'pagato' => array('type' => 'boolean', 'null' => true, 'default' => '0'),
		'pagatoRitenutaAcconto' => array('type' => 'boolean', 'null' => true, 'default' => '0'),
		'faseattivita_id' => array('type' => 'integer', 'null' => true, 'default' => null),
		'indexes' => array(
			'PRIMARY' => array('column' => 'id', 'unique' => 1),
			'AttivitàFattureRicevute' => array('column' => 'attivita_id', 'unique' => 0),
			'IDFatturaRicevuta' => array('column' => 'id', 'unique' => 0)
		),
		'tableParameters' => array('charset' => 'latin1', 'collate' => 'latin1_swedish_ci', 'engine' => 'MyISAM')
	);
	...
	public $fornitori = array(
		...
		'indexes' => array(
			'PRIMARY' => array('column' => 'id', 'unique' => 1),
			'IDPersona' => array('column' => 'id', 'unique' => 1)
		),
		'tableParameters' => array('charset' => 'latin1', 'collate' => 'latin1_swedish_ci', 'engine' => 'MyISAM')
	);
	...
	public $legenda_stato_attivita = array(
		'id' => array('type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary'),
	...
	public $primanota = array(
		...
		'importo' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => '19,4'),
		'attivita_id' => array('type' => 'integer', 'null' => true, 'default' => null),
		'legenda_cat_spesa_id' => array('type' => 'integer', 'null' => true, 'default' => null),
		'provenienzasoldi_id' => array('type' => 'integer', 'null' => true, 'default' => null, 'length' => 6),
		'fatturaemessa_id' => array('type' => 'integer', 'null' => true, 'default' => null),
		'fatturaricevuta_id' => array('type' => 'integer', 'null' => true, 'default' => null),
	...
	public $righefatture = array(
		...
		'DescrizioneVoci' => array('type' => 'string', 'null' => true, 'default' => null, 'length' => 250, 'collate' => 'latin1_swedish_ci', 'charset' => 'latin1'),
		'Ordine' => array('type' => 'integer', 'null' => true, 'default' => null, 'length' => 4),
		'Importo' => array('type' => 'float', 'null' => true, 'default' => null, 'length' => '19,4'),
